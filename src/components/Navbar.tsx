...
function Navbar() {
    ...
    return (
        <div className="flex w-screen justify-center">
            <div id="back-nav" className="p-4 h-16 justify-center w-screen bg-gray-800 flex space-x-4"></div>
          <div id="nav" className="p-4 justify-center w-screen h-16 bg-gray-800 flex space-x-4 absolute max-w-6xl">
  ...
  function AvatarCircle(props: any) {
    return (
      <div className="flex mr-auto items-center space-x-4">
        ...
        <img className="w-12 h-auto" src="https://i.imgur.com/4dBDNkO.png" alt="Soofa Logo" />
